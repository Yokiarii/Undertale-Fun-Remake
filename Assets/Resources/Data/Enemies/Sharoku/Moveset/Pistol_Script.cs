...
public class Pistol_Script : MonoBehaviour
{
    ...
    IEnumerator PistolLogic()
    {
        ...
        SharokuScript.Instance.Arm_Right.transform.SetParent(SharokuScript.Instance.Body.transform);
        SharokuScript.Instance.Parts_Arms.transform.SetAsLastSibling();
    ...
    IEnumerator QuitAttack(Image Arm)
    {
        ...
        SharokuScript.Instance.Arm_Right.transform.SetParent(SharokuScript.Instance.Parts_Arms.transform);
        SharokuScript.Instance.Parts_Arms.transform.SetAsFirstSibling();
